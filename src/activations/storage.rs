...
/// - `mneme_substrate::activations::orcha::storage` → `"orcha"`
/// - `mneme_substrate::activations::claudecode_loopback::storage` → `"claudecode_loopback"`
///
/// # Arguments
...
pub fn extract_activation_name(module_path: &str) -> &str {
    // Module path format: mneme_substrate::activations::{activation_name}::storage
...
mod tests {
    ...
    fn test_extract_activation_name() {
        assert_eq!(
            extract_activation_name("mneme_substrate::activations::orcha::storage"),
            "orcha"
        );
        assert_eq!(
            extract_activation_name("mneme_substrate::activations::claudecode_loopback::storage"),
            "claudecode_loopback"
        );
        assert_eq!(
